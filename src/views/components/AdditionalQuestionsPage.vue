  ...
  methods: {
        ...
        if (auditData) {
          ...
          try {
            const directResponse = await axios.get(
              `https://spbebackend-production.up.railway.app/api/auth/audit-requests/${this.auditId}`,
              {
                headers: {
                  'Authorization': `Bearer ${token}`
                }
    ...
    async downloadPreviousAudit() {
      ...
      try {
        const response = await axios.get(
          `https://spbebackend-production.up.railway.app/api/auth/download-audit-file/${this.auditId}`,
          {
            headers: {
              'Authorization': `Bearer ${token}`
            },
      ...
      try {
        ...
        try {
          const resultsResponse = await axios.get(
            `https://spbebackend-production.up.railway.app/api/auth/audit-results/${this.auditId}`,
            {
              headers: {
                'Authorization': `Bearer ${token}`,
        ...
        try {
          const auditResponse = await axios.get(
            `https://spbebackend-production.up.railway.app/api/auth/audit/${this.auditId}`,
            {
              headers: {
                'Authorization': `Bearer ${token}`
              }
    ...
    async submitAnswers() {
      ...
      try {
        ...
        const response = await axios.post(
          `https://spbebackend-production.up.railway.app/api/auth/save-additional-answers/${this.auditId}`,
          data,
          {
            headers: {
              'Authorization': `Bearer ${token}`,
    ...
    async downloadAuditResult() {
      ...
      try {
        ...
        const response = await axios.get(
          `https://spbebackend-production.up.railway.app/api/auth/audits/${this.auditId}/download-result`,
          {
            headers: {
              'Authorization': `Bearer ${token}`
            },
